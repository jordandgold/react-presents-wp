<? include('header.php'); ?>
    ...
    <div class="interior_header" style="background-image: url(../img/slide_3.jpg);" data-0="background-position:0px 0px;" data-50000="background-position:0px -15000px;">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="page_excerpt">
                    <p>React Presents has a long history of supporting local artists by giving them a stage to perform on.  We pride ourselves on fostering the local scene and are always on the lookout for budding talent. If you’re a regional artist and would like to open up one of our shows, <a href="#">please fill out this form</a>.</p>
                </div>
            </div>
        </div>
